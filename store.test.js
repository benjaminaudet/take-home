...
describe("Store Partners Discount Offers", () => {
  it("[Global #1] should decrease the discount and expiresIn", () => {
    expect(
  ...
  it("[Global #2] should decrease twice as fast when the discount offer expires", () => {
    expect(
  ...
  it("[Naturalia #1] should increase the older it gets", () => {
    expect(
  ...
  it("[Naturalia #2] should increase twice as fast the older it gets when expiration date has passed", () => {
    expect(
  ...
  it("[Vinted #1] should increase the older it gets (+1 when 11 days or more left)", () => {
    expect(
  ...
  it("[Vinted #2] should increase twice as fast the older it gets (+2 when 10 days or less left)", () => {
    expect(
  ...
  it("[Vinted #3] should increase thrice as fast the older it gets (+3 when 5 days or less left)", () => {
    expect(
